...
public class DAOFirebaseImagenes<T> {

    FirebaseFirestore mFirestoreDB;
    InterfaceDAOFirebase mActivity;
    ...
    public DAOFirebaseImagenes(InterfaceDAOFirebase activity, String firebaseCollection, Class<T> objectClassOfStoredElement) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d("DAVID ***>", "leyendo " + task.getResult().size() + " elementos");
                            ...
                            mActivity.afterReadAllImagenes(list);
                        } else {
